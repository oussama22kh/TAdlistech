...
public class Liste {
	...
	public boolean est_vide() {
		return this.Info == null & this.Suiv == null;
	}

	public Liste rechercher(Element e) {
		Liste pt = this;
		while (pt != null) {
			// recherche de element e par id
			if (pt.Info.getId() == e.getId()) {
				return pt;
			}
			pt = pt.Suiv;
		}
	...
	public Liste difference(Liste L2) {
		Liste L3 = new Liste();
		Liste L1 = this;
		int i = 0;
		while (L1 != null) {
			if (L2.rechercher(L1.Info) == null) {
				L3.inserer(i, L1.Info);
				i++;
			}
			L1 = L1.Suiv;
